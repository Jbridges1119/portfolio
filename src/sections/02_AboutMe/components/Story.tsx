  ...
  return (
      ...
      <Stack spacing={2}>
        <motion.div initial={{width:0}}  transition={{ duration: 1}}>
            <Typography variant="h2" sx={{ color: "#4345E8", textAlign:'left'}}>Hello!</Typography></motion.div>
            <Divider />
            ...
            I'd love to hear from you. Whether it's a job opportunity, a project collaboration, or just to chat. Please feel free to contact me.</Typography>
            <Divider />
